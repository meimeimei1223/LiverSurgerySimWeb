...
//
// Frozen snapshot for paper reproducibility (AE-CAI 2026).
// CACHE_NAME is separated from the live deployment at the repo root
// ('/LiverSurgerySimWeb/' uses 'liver-sim-v***') to avoid collision.
// Service Worker scope is automatically limited to this subfolder by its
// location (browsers infer scope from the sw.js path).
const CACHE_NAME = 'liver-sim-paper-benchmark-v1';
const ASSETS = [
  './',
  './index.html',
  './softbody.js',
